   ...
   return (
      <section id="blog">
         ...
         <div className="mx-auto my-12 w-full max-w-[800px] space-y-4 px-4 sm:px-6 lg:px-8">
            <Suspense
               fallback={
                  <div className="mb-8 h-64 w-full animate-pulse rounded-lg bg-gray-200"></div>
               }
            >
               {post.metadata.image && (
                  <div className="mb-8">
            ...
            <div className="flex flex-col">
               <h1 className="title text-3xl font-medium tracking-tighter">
                  {post.metadata.title}
               </h1>
            </div>
            ...
            <article
               className="prose mx-auto max-w-full dark:prose-invert"
